...
export function TaskCard({ 
  ...
  const getPriorityColor = () => {
    switch (priority) {
      case 'high': return 'bg-red-500/10 text-red-600 dark:bg-red-500/20 dark:text-red-400';
      case 'medium': return 'bg-yellow-500/10 text-yellow-600 dark:bg-yellow-500/20 dark:text-yellow-400';
